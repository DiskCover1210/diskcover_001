...
{	 var option ="<option value=''>Seleccione curso</option>"; 
	...
	function ciudad(idpro)
	{
	 ...
	 function cliente_proveedor(cli)
	 {
		...
		var pass = $('#txt_clave').val();
		  $.ajax({
		  url: '../controlador/detalle_estudianteC.php?cliente_proveedor=true',
		  type:'post',
		  dataType:'json',
		  data:{cli:cli},
		  success: function(response){
	...
	function existente_clave(ci,cla)
	{
		...
		var pass = $('#txt_clave').val();
		  $.ajax({
		  url: '../controlador/detalle_estudianteC.php?existente_clave=true',
		  type:'post',
		  dataType:'json',
		  data:{ci:ci,cla:cla},
		  success: function(response){
	...
	function existente_usu(usu)
	{
		var pass = $('#txt_clave').val();
		  ...
		  $.ajax({
		  url: '../controlador/detalle_estudianteC.php?existente=true',
		  type:'post',
		  dataType:'json',
		  data:{usu:usu},
		  success: function(response){
...
<div class="container">	
  ...
  <div class="tab-content" style="background-color:#E7F5FF;">
    <div id="home" class="tab-pane fade in active">
    	<table class="table-responsive"><tr><td class="col-sm-12"> <h3>MATRICULA</h3> </td><td class="text-right"><button type="button" id="btn_guar_est" class="btn btn-success btn-sm" onclick="actualizar_est('menu2')"><span class="glyphicon glyphicon-floppy-disk" aria-hidden="true"></span>  Guardar y continuar</button></td></tr></table>       
    ...
    <div id="menu2" class="tab-pane fade">
    	...
    	<button type="button" class="btn btn-success btn-sm" id="btn_guar_fami" onclick="actualizar_familia('menu3')"><span class="glyphicon glyphicon-floppy-disk" aria-hidden="true"></span>  Guardar y continuar</button></td></tr></table>
      <div class="row">
      	<div class="col-sm-12">
      		<div class="col-sm-6">
    ...
    <div id="menu3" class="tab-pane fade">
    	...
    	<button type="button" class="btn btn-success btn-sm" id="btn_guar_repre" onclick="actualizar_representante()"><span class="glyphicon glyphicon-floppy-disk" aria-hidden="true"></span>  Guardar</button></td><td>
    	<button type="button" class="btn btn-success btn-sm" id="btn_guar_fin_rep" onclick="procesos('fin_g')"><span class="glyphicon glyphicon-floppy-saved" aria-hidden="true"></span>  Guardar y Finalizar</button></td></tr></table>           
      <div class="row">
      	<div class="col-sm-12">
      	   <div class="col-sm-3">
      		   <b>REPRESENTANTE</b>
