...
if(isset($_GET['mod'])) 
		{
          ...
          $imag = '<img src="'.$url.'" style="height:36% ;width: 18%;margin: 5px" alt="user image" class="text-muted pull-left">';
					break;
				}else
				{
          $imag = '<img src="../../img/logotipos/diskcover_web.gif" style="height:36% ;width: 18%;margin: 5px" alt="user image" class="text-muted pull-left">';
...
<header class="main-header">	
    <nav class="navbar navbar-fixed-top">
      <div class="container-fluid" style="color: #ffff"  id="datos">         
        <div class="row">
        <div class="logo">          
             <div class="logo-mini">              
                <div class="col-sm-6">
                   ...
                   <div class="item">
                      ...
                      <p class="message"  style="color: #ffff">
                        DiskCover System <br>
                        R.u.C. 0702164179001 <br>
                        Representante: Walter Jail Vaca Prieto
                      </p>
                   </div>                           
                </div>
                <div class="col-sm-6">
                   <div class="item">            
                     <img src="../../img/logotipos/diskcover_web.gif" style="height:36% ;width: 18%;margin: 5px" alt="user image" class="text-muted pull-right">  
                       <p class="message"  style="color: #ffff">
                         Direccion: PABLO PALACIO N23-154 Y AV. LA GASCA<br>
                         Telefono: 025008082 / FAX: 025008082<br>
                         Email: diskcover@msn.com<br>
                       </p>
                  </div>        
                </div>
             </div>
             <div class="logo-lg">
              <div class="text-center">
                 <span class="glyphicon glyphicon-envelope" aria-hidden="true" title="Email: diskcover@msn.com"></span>
       ...
       ?>
              ...
              <li class="nav-item dropdown">
                ...
                <ul class="dropdown-menu" aria-labelledby="reporte">
                  ...
                  <li class="dropdown-item"><a href="diario_general.php?mod=contabilidad&acc=saldo_fac_submodulo&acc1=Comprobantes Procesados&b=1" >Diario general 
                  ...
                  -->
                  <li class="dropdown-item"><a href="contabilidad/saldo_fac_submodulo.php?mod=contabilidad&acc=saldo_fac_submodulo&acc1=Comprobantes Procesados&b=1" >Saldo de facturas en SubModulos</a></li>
...
<!--------inicio de pestañas de educativo---->
          ...
          <div class="btn-group">
         	<a href="logout.php" class="btn btn-sm btn-primary"><img src="../../img/png/salirs.png"  style="height: 55%; width:55%"></a>
   			  <a href="panel.php?mos2=e" class="btn btn-sm btn-primary"><img src="../../img/png/salire.png"  style="height: 55%; width:55%"></a>          	
          </div>
          </ul>
