		...
		<div class="col-xs-12">
			<div class="box">
						<h1 align="center"><p>Migracion <?php if (isset($_POST['base_mi'])) { echo $_POST['base_mi'];} ?></p></h1>
							...
							<form role="form" enctype="multipart/form-data" action="migra4.php" method="POST">
								<div class="box-body">
									<div class="col-md-5">
									  <div class="form-group">
										<label for="exampleInputEmail1">Servidor sql server</label>
										<input type="text" class="form-control" id="server" placeholder="Servidor sql server" 
										name="server">
									  </div>
									 </div>
									 <div class="col-md-5">
								...
								<div class="box-body">
									<div class="col-md-5">
									  <div class="form-group">
										<label for="exampleInputEmail1">Base de datos sql server</label>
										<input type="text" class="form-control" id="base_mi" placeholder="Base de datos sql server"
										name="base_mi">
									  </div>
									 </div>
									 <div class="col-md-5">
								...
								<div class="box-body">
									<div class="col-md-5">
									  <div class="form-group">
										<label for="exampleInputEmail1">Usuario sql server</label>
										<input type="text" class="form-control" id="user" placeholder="Usuario sql server"
										name="user">
									  </div>
									 </div>
									 <div class="col-md-5">
								...
								<div class="box-body">
									<div class="col-md-5">
									  <div class="form-group">
										<label for="exampleInputEmail1">Clave sql server</label>
										<input type="text" class="form-control" id="password" placeholder="Clave sql server"
										name="password">
									  </div>
									 </div>
									 <div class="col-md-5">
				...
				if(isset($_POST['submitweb3'])) 
				{
					...
					for($i=0; $i < count($tabla); $i++)
					{
						...
						AND $tabla[$i]['tabla']!='trace_xe_event_map')
						{
							...
							WHERE table_schema = '".$base_my."'
							AND table_name = '".$tabla[$i]['tabla']."'" ;
							$consulta=$conexion->query($sql);
							$filas=$consulta->fetch_assoc();
							$regis = $filas['cont'];
							if($regis==0)
							{
								echo "No existe tabla ".$tabla[$i]['tabla'].'<br>';
							}
							else
							{
								$sql="SELECT count(*) AS cont FROM ".$tabla[$i]['tabla']." ";
						...
						<div class="col-md-3 col-sm-6 col-xs-12">
						  <div class="info-box bg-green">
							...
							<div class="info-box-content">
							  <span class="info-box-text">Migrado</span>
							  <div class="progress">
								<div class="progress-bar" style="width: 100%"></div>
							  </div>
								  <span class="progress-description">
									<?php echo $database; ?> 100% completado
								  </span>
							</div>
							<!-- /.info-box-content -->
						  </div>
