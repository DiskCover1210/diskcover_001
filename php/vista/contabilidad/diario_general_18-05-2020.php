     ...
     <div class="row"> 
        ...
        <div class="col-sm-6">
           		            ...
           		            <table class="col-xs-12">
           			            <tr style="height: 20px">
           				            <td  style="width:125px;" >
           				              <label class="radio-inline"><input type="radio" name="OpcP" id="OpcT" onclick="libro_general();" checked="">Todos</label>
           				            </td>
           				            <td style="width:125px;" >
           				              <label class="radio-inline"><input type="radio" name="OpcP" id="OpcCI" onclick="libro_general();">Ingresos</label>
           				            </td>
           				            <td style="width:80px;" >
           					            <label class="radio-inline"><input type="radio" name="OpcP" id="OpcCE" onclick="libro_general();">Egreso</label>
           				            </td>
           				            <td style="width:100px;" >
           					            <label class="radio-inline"><input type="radio" name="OpcP" id="OpcCD" onclick="libro_general();">Diario</label>
           				            </td>
           				            <td  style="width:60px;" ></td>           				
           			            </tr>
           			            <tr>
           				            <td>
           					            <label class="radio-inline"><input type="radio" name="OpcP" id="OpcND" onclick="libro_general();">Notas de debito</label>
           				            </td>
           				            <td>
           					            <label class="radio-inline"><input type="radio" name="OpcP" id="OpcNC" onclick="libro_general();">Notas de credito</label>
           				            </td>
           				            <td>           					
           					            <label class="radio-inline"><input type="radio" name="OpcP" id="OpcA" onclick="libro_general();">Anulado</label> 
           				            </td>
           				            <td>
	  	...
	  	<div class="col-sm-3">
	  			...
	  			<select class="form-control input-sm" id="DCUsuario" onclick="libro_general();">
           			<option value="">Seleccione usuario</option>
           		</select>	 
	  			<label class="radio-inline input-sm"><input type="checkbox" name="CheckAgencia" id="CheckAgencia" onchange="consultar_datos();"> Por Agencia</label>
           		<select class="form-control input-sm" id="DCAgencia" onclick="libro_general();">
           			<option value="">Seleccione usuario</option>
           		</select>
	   </div>       		
