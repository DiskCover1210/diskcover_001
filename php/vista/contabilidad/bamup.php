...
<!-- 
						<a id='l2' class="btn btn-default" title="Procesar Balance Analito Mensual de Situación"
						href="contabilidad.php?mod=contabilidad&acc=bamup&acc1=Procesar balance mensual&
