		 ...
		 <div class="col-xs-12">
			 <div class="box">
			  <div class="box-header">
					...
					<h4 class="box-title" id='mostraEm'>
						<a class="btn btn-default"  title="Mostrar Vencimiento" data-placement="right"
						onclick='' target="_blank" id='mostraEm_' href="descarga.php?mod=contabilidad&acc=mosEm&acc1=Balance de Comprobacion/Situación/General&ti=<?php echo $_SESSION['INGRESO']['ti']; ?>
