...
require_once("../../../diskcover_lib/excel/plantilla.php");
require_once("../../../diskcover_lib/fpdf/reporte_comp.php");
...
function buscarUsuario(){
		...
		$sql = "SELECT *
				  ...
				  WHERE ID = '".$cade[0]."' ORDER BY Nombre_Usuario;";
		//echo $sql;
		//die();
		...
		//while($filas=$consulta->fetch_assoc()){
			...
			?>
				...
				'empresa.php?mod=empresa&acc=cambiou&acc1=Administrar%20Usuario');
				//$camne=array();
...
function buscarEntidad_usu()
{
		...
		?>
			...
			while($filas=$consulta->fetch_assoc()){
				?>
					<option value='<?php echo $filas['ID']; ?>'><?php echo $filas['CI_NIC'].' '.$filas['Nombre_Usuario']; ?></option>
				<?php
				//echo '<div id="alerta" class="alert alert-success visible">'.$filas['Empresa'].'</div>';
				$i++;
			}
...
function modificarEmpresa()
{
	...
	Contraseña_DB='".$_POST['campo8']."' ,Tipo_Base='".$_POST['campo9']."',
			...
			?>
				<div class="col-md-4">
					<div class="form-group">
					    ...
					    <select class="form-control" name="Estado" id='Estado' >
							<option value='<?php echo $filas[7]; ?>'><?php echo $filas[7]; ?></option>
				...
				<div class="col-md-4">
					<div class="form-group">
					  ...
					  <input type="date" class="form-control" id="FechaR" placeholder="FechaR" 
					  value='<?php echo date('Y-m-d',strtotime($filas[15])) ?>' 
					  onKeyPress="return soloNumeros(event)"  maxlength="10" >
					</div>
				</div>
				<div class="col-md-4">
					<div class="form-group">
					  ...
					  <input type="date" class="form-control" id="Fecha" placeholder="Fecha" 
					  value='<?php echo date('Y-m-d',strtotime($filas[18])) ?>' onKeyPress="return soloNumeros(event)" 
					  maxlength="10" >
					</div>
				</div>
				<div class="col-md-4">
					<div class="form-group">
					  ...
					  value='<?php echo date('Y-m-d',strtotime($filas[19])) ?>'   onKeyPress="return soloNumeros(event)" maxlength="10">
					</div>
				</div>
				<div class="col-md-4">
					<div class="form-group">
					  <label for="Servidor">Servidor</label>
					  <input type="text" class="form-control" id="Servidor" placeholder="Servidor" value='<?php echo $filas[9]; ?>'>
					</div>
				</div>
				<div class="col-md-4">
					<div class="form-group">
					  <label for="Base">Base</label>
					  <input type="text" class="form-control" id="Base" placeholder="Base" value='<?php echo $filas[10]; ?>'>
					</div>
				</div>
				<div class="col-md-4">
					<div class="form-group">
					  ...
					  <input type="text" class="form-control" id="Usuario" placeholder="Usuario" value='<?php echo $filas[11]; ?>'>
					</div>
				</div>
				<div class="col-md-4">
					<div class="form-group">
					  <label for="Clave">Clave</label>
					  <input type="text" class="form-control" id="Clave" placeholder="Clave" value='<?php echo $filas[12]; ?>'>
					</div>
				</div>
				<div class="col-md-4">
					<div class="form-group">
					  <label for="Motor">Motor BD</label>
					  <input type="text" class="form-control" id="Motor" placeholder="Motor" value='<?php echo $filas[13]; ?>'>
					</div>
				</div>
				<div class="col-md-4">
					<div class="form-group">
					  ...
					  <input type="text" class="form-control" id="Puerto" placeholder="Puerto" value='<?php echo $filas[14]; ?>'>
					</div>
				</div>
				<div class="col-md-12">
					<div class="form-group">
					  <label for="Mensaje">Mensaje</label>
					  <input type="text" class="form-control" id="Mensaje" placeholder="Mensaje" value='<?php echo $filas[8]; ?>'>
					</div>
				</div>
			<?php
			//echo '<div id="alerta" class="alert alert-success visible">'.$filas['Empresa'].'</div>';
...
function validarEnt(){
	 ...
	 if ($entidadfilter or $entidadfilter1){
		...
		$i=0;
		while($filas=$consulta->fetch_assoc()){
			echo '<div id="alerta" class="alert alert-success visible" align="center">ENTIDAD: '.$filas['Nombre_Entidad'].'</div>';
			$i++;
		}
		if($i==0)
		{
