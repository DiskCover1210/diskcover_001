        ...
        <div class="logo"  style="background-color:#ffff">  
			...
			?>
				<div class="logo-mini">              
					...
					<div class="col-sm-6">
					   <div class="item">            
						 <img src="../../img/logotipos/diskcover_web.gif" style="height:36% ;width: 18%;margin: 5px" alt="user image" class="text-muted pull-right" data-toggle="modal" data-target="#myModal_info">  
						   <p class="message"  style="color: #394082">
