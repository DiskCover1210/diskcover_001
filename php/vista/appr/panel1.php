...
<script>
	...
	function enviar(cod,me,pro,cant)
	{
	...
	function selec_p(id) 
	{
		...
		$('#formu1 input[type=checkbox]').each(function(){
            if (this.checked) {
				...
				document.getElementById("total_"+$(this).val()).style.display = "block";
            }
			else
			{
				document.getElementById("canti_"+$(this).val()).style.display = "none";
				document.getElementById("total_"+$(this).val()).style.display = "none";
			}
        }); 
        /*if (selected != '') 
		{
