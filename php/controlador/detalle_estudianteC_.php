...
{
  echo json_decode($controlador->fact_emitidas($_POST['codigo']));

}
if(isset($_GET['imprimir_excel']))
{
  $controlador->exportar_Excel($_GET['codigo']);
...
class detalle_estudianteC
{
  ...
  {
     return $this->modelo->facturas_emitidas_tabla($codigo);
  }
	function encode($arr) {
	$new = array(); 
  ...
  //	echo digito_verificadorf($parametros,1).'<br>';
     //print_r(digito_verificadorf($parametros,1));
  	 $dato[0]['campo']='Codigo';
     $dato[0]['dato']=$parametros['codigo'];
     $dato[1]['campo']='CI_RUC';
  ...
  function actualizar_alumno($parametros)
  {
  	...
  	$datos[1]['campo']='Grupo';
  	$datos[1]['dato']=$parametros['select_curso'];
  	$datos[2]['campo']='Sexo';
  	$datos[2]['dato']=$sexo;
  	$datos[3]['campo']='Email';
  	...
  	$datos[5]['dato']=$parametros['ciudad'];
  	$datos[6]['campo']='Fecha_N';
    $datos[6]['dato']=$parametros['fechan'];    
  	$datos[7]['campo']='Direccion';
    $datos[7]['dato']=$parametros['nom_curso'];
  	$datos[8]['campo']='DireccionT';
    $datos[8]['dato']=$parametros['dir_est'];
  	$datos[9]['campo']='TD';
    $datos[9]['dato']='C';
    $datos[10]['campo']='Cedula';
    $datos[10]['dato']=$parametros['cedula'];

    $datos1[0]['campo']='Nacionalidad';
    $datos1[0]['dato']=$parametros['nacionalidad'];
    $datos1[1]['campo']='Procedencia';
    $datos1[1]['dato']=$parametros['procedencia'];
    $datos1[2]['campo']='Observaciones';
    $datos1[2]['dato']=$parametros['observacion'];
   ...
   function actualizar_fami($parametros)
  {
  	...
  	$datos[0]['dato']=$parametros['nombre_p'];
  	$datos[1]['campo']='Nacionalidad_P';
  	$datos[1]['dato']=$parametros['nacionalidad_p'];
  	$datos[2]['campo']='Profesion_P';
  	$datos[2]['dato']=$parametros['profesion_p'];
  	$datos[3]['campo']='Lugar_Trabajo_P';
  	$datos[3]['dato']=$parametros['trabajo_p'];
  	...
  	$datos[7]['dato']=$parametros['nombre_m'];
  	$datos[8]['campo']='Nacionalidad_M';
  	$datos[8]['dato']=$parametros['nacionalidad_m'];
  	$datos[9]['campo']='Profesion_M';
  	$datos[9]['dato']=$parametros['profesion_m'];
  	$datos[10]['campo']='Lugar_Trabajo_M';
  	$datos[10]['dato']=$parametros['trabajo_m'];
    ...
    $datos[16]['dato']=$parametros['ocupacion_p'];
    $datos[17]['campo']='Ocupacion_M';
    $datos[17]['dato']=$parametros['ocupacion_m'];
    return $this->modelo->actualizar_datos($datos,'Clientes_Matriculas','Codigo',$parametros['codigo']);
...
$fecha=strftime("%A %d de %B del %Y");
	...
	$tablaHtml.='<table>
	<tr>
		<td width="360"><b><u>'.$datos[0]['Direccion'].'</u></b></td><td  width="360"><b>'.$datos[0]['Curso_Superior'].'</b></td>
	</tr>
	...
	<tr><td width="170"><b>Telefono</b></td><td width="300">'.$datos[0]['Telefono'].'</td><td width="110"><b>Nacionalidad:</b></td><td width="300">'.$datos[0]['Nacionalidad'].'</td></tr>
	<tr><td width="170"><b>Plantel que proviene:</b></td><td width="300">'.$datos[0]['Procedencia'].'</td></tr>
	<tr><td width=""></td></tr>
	<tr><td width=""><b>DATOS DEL PADRE</b></td></tr>
	<tr><td width="110"><b>Nombre:</b></td><td width="295">'.$nom_pa.'</td><td width="90"><b>Telefono:</b></td><td width="300">'.$datos[0]['Celular_P'].'</td></tr><tr><td width="110"><b>Nacionalidad:</b></td><td width="295">'.$na_pa.'</td><td  width="90"><b>Profesion:</b></td><td width="300">'.$datos[0]['Profesion_P'].'</td></td></tr><tr><td  width="110"><b>&nbsp;</b></td><td width="283">&nbsp;</td><td width="90"><b>Ocupacion:</b></td><td width="300">'.$datos[0]['Ocupacion_P'].'</td></tr>
	<tr><td width=""></td></tr>
	<tr><td width=""><b>DATOS DE LA MADRE</b></td></tr>
	<tr><td width="110"><b>Nombre:</b></td><td width="295">'.$nom_ma.'</td><td width="90"><b>Telefono:</b></td><td width="300">'.$datos[0]['Celular_M'].'</td></tr><tr><td width="110"><b>Nacionalidad:</b></td><td width="295">'.$na_ma.'</td><td width="90"><b>Profesion:</b></td><td width="300">'.$datos[0]['Profesion_M'].'</td></tr><tr><td width="110"><b>&nbsp;</b></td><td width="283">&nbsp;</td><td width="90"><b>Ocupacion:</b></td><td width="300">'.$datos[0]['Ocupacion_M'].'</td></tr>
	<tr><td width=""></td></tr>
	<tr><td width="750"><b>DATOS DEL REPRESENTANTE</b></td></tr>
	<tr><td width="100"><b>Nombre:</b></td><td width="295">'.$nom_re.'</td><td width="90"><b>Telefono:</b></td><td width="180">'.$datos[0]['Telefono_RS'].'</td></tr><tr><td height="" width="110"><b>&nbsp;</b></td><td width="285">&nbsp;</td><td  width="90"><b>Profesion:</b></td><td width="300">'.$datos[0]['Profesion_R'].'</td></tr><tr><td height="" width="110"><b>&nbsp;</b></td><td width="285">&nbsp;</td><td width="90"><b>Ocupacion:</b></td><td width="300">'.$datos[0]['Ocupacion_R'].'</td></tr>
</table>
<table>
    <tr>
	...
	<tr>
		...
		$this->pdf->cabecera_reporte_colegio($_SESSION['INGRESO']['item'].'_ACTA_DE_MATRICULA_'.$usu,'ACTA DE MATRICULA',utf8_decode($tablaHtml),$contenido,$image,'','',10,false,$email);
  ...
  function pdf_registro($usu,$pass,$nuevo,$email)
  {
	...
	<tr><td height="150" width="150"><b>CURSO</b></td><td height="150"  width="300">'.$datos[0]['Direccion'].'</td></tr>
...
if($datos[0]['Archivo_Foto'] !='.' && $datos[0]['Archivo_Foto'] !='')
{
  ...
  function pdf_matricula($usu,$pass,$nuevo,$email)
  {
	...
	<tr><td width="200" height=""><b>MATRICULA No</b></td><td width="200" height="">'.$datos[0]['Matricula_No'].'</td></tr>
	<tr><td width="200" height=""><b>Folio No</b></td><td width="200" height="">'.$datos[0]['Folio_No'].'</td></tr>
	<tr><td width="200" height=""><b>FECHA DE MATRICULA</b></td><td width="" height="">'.$datos[0]['Fecha_M']->format("Y-m-d").'</td></tr><tr><td width="200" height=""><b>NACIONALIDAD</b></td><td width="" height="">'.$datos[0]['Nacionalidad'].'</td></tr>';
  if($datos[0]['Especialidad'] != '.')
  {
    $tablaHtml.='<tr><td width="200" height=""><b>ESPECIALIDAD</b></td><td width="" height="">'.$datos[0]['Especialidad'].'</td></tr>';
  }	
	$tablaHtml.='<tr><td width="200" height=""><b>AÑO</b></td><td width="" height="">'.$this->empresa[0]['Anio_Lectivo'].'</td></tr>
	<tr><td width="200" height=""><b>SECCION</b></td><td width="" height="">'.$datos[0]['Seccion'].'</td></tr>
	<tr><td width="200" height=""><b>NIVEL DE ESTUDIO</b></td><td width="" height="">'.$datos[0]['Curso_Superior'].'</td></tr>
	<tr><td width="200" height=""><b>CURSO - GRADO</b></td><td width="" height="">'.utf8_encode($datos[0]['Grupo']).' '.$datos[0]['Direccion'].'</td></tr>
	<tr><td height="20">&nbsp;</td></tr>
	<tr><td width="200" height=""><b><u>DATOS PERSONALES</u></b></td><td width="" height=""></td></tr>
	<tr><td width="200" height=""><b>NOMBRES Y APELLIDOS</b></td><td width="300" height="">'.$datos[0]['Cliente'].'</td></tr>
	<tr><td width="200" height=""><b>CEDULA</b></td><td width="" height="">'.$datos[0]['Cedula'].'</td></tr>
	<tr><td width="200" height=""><b>LUGAR DE NACIMIENTO</b></td><td width="" height="">'.$datos[0]['Ciudad'].'</td></tr>
	<tr><td width="200" height=""><b>FECHA DE NACIMIENTO</b></td><td width="" height="">'.$datos[0]['Fecha_N']->format("Y-m-d").'</td></tr>
	<tr><td width="200" height=""><b>DOMICILIO</b></td><td width="550" height="">'.$datos[0]['DireccionT'].'</td></tr>
	<tr><td width="200" height=""><b>TELEFONO</b></td><td width="300" height="">'.$datos[0]['Telefono'].'</td></tr>
	<tr><td height="20">&nbsp;</td></tr>
	<tr><td><b><u>DATOS FAMILIARES</u></b></td><td width="" height=""></td></tr>
	<tr><td width="200" height=""><b>NOMBRES DEL PADRE</b></td><td width="300" height="">'.$datos[0]['Nombre_Padre'].'</td></tr>
	<tr><td width="200" height=""><b>NACIONALIDAD</b></td><td width="300" height="">'.$datos[0]['Nacionalidad_P'].'</td></tr>
	<tr><td width="200" height=""><b>PROFESION</b></td><td width="400" height="">'.$datos[0]['Profesion_P'].'</td></tr>
	<tr><td width="200" height=""><b>LUGAR DE TRABAJO</b></td><td  width="550" height="">'.$datos[0]['Lugar_Trabajo_P'].'</td></tr>
	<tr><td width="200" height=""><b>TELEFONO</b></td><td width="300" height="">'.$datos[0]['Celular_P'].'</td></tr>
	<tr><td height="20">&nbsp;</td></tr>
	<tr><td width="200" height=""><b>NOMBRES DEL MADRE</b></td><td width="300" height="">'.$datos[0]['Nombre_Madre'].'</td></tr>
	<tr><td width="200" height=""><b>NACIONALIDAD</b></td><td width="300" height="">'.$datos[0]['Nacionalidad_M'].'</td></tr>
	<tr><td width="200" height=""><b>PROFESION</b></td><td width="400" height="">'.$datos[0]['Profesion_M'].'</td></tr>
	<tr><td width="200" height=""><b>LUGAR DE TRABAJO</b></td><td  width="550" height="">'.$datos[0]['Lugar_Trabajo_M'].'</td></tr>
	<tr><td width="200" height=""><b>TELEFONO</b></td><td width="300" height="">'.$datos[0]['Celular_M'].'</td></tr>
	<tr><td height="20">&nbsp;</td></tr>
	<tr><td width="200" height=""><b>REPRESENTANTE</b></td><td width="300" height="">'.$datos[0]['Representante_Alumno'].'</td></tr>
	<tr><td width="200" height=""><b>CEDULA DE IDENTIDAD</b></td><td width="" height="">'.$datos[0]['CI_R'].'</td></tr>
	<tr><td width="200" height=""><b>TELEFONO</b></td><td width="300" height="">'.$datos[0]['Telefono_RS'].'</td></tr><tr><td width="200" height=""><b>Email</b></td><td width="300" height="">'.$datos[0]['Email2'].'</td></tr> 
</table>
<table>
...
if (!file_exists('../../img/img_estudiantes/'.$datos[0]['Archivo_Foto'])) 
   ...
   function exportar_Excel($codigo)
  {
    $reporte_Excel = true;
    $this->modelo->facturas_emitidas_excel($codigo,$reporte_Excel);
  }
