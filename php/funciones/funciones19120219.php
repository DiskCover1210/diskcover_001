...
function redireccion($pag=null,$idMen=null)
{
	...
	// </script>";
	echo "<script type='text/javascript'>window.location='".$uri."/diskcover_php/vista/".$pag.".php'</script>";
}
...
function digito_verificadorf($ruc,$pag=null,$idMen=null,$item=null)
{
	...
	//codigo walter
		...
		else
		{
			...
			echo 'RUC/CI ('.$Tipo_Beneficiario.') '.$Codigo_RUC_CI;
			return 'RUC/CI ('.$Tipo_Beneficiario.') '.$Codigo_RUC_CI;
		}
	...
	/*if(strlen($ruc)==10 and is_numeric($ruc))
	{
		...
		if($pro>=24)
		{
			echo "<p style='color:#FF0000;'>incorrecto los dos primeros digitos</p>";
			$ban=1;
		}
		//verificamos el tercer registros
		if($ter>6)
		{
			echo "<p style='color:#FF0000;'>incorrecto el tercer digito</p>";
			$ban=1;
		}
		//partimos string
		$arr2 = str_split($resu1);
...
//excel
function exportar_excel_generico($stmt,$ti=null,$camne=null,$b=null)
{
	excel_file($stmt,$ti,$camne,$b); 
}
...
function ImprimirDoc($stmt,$id=null,$formato=null,$va=null,$imp=null)
{
	require_once("../../diskcover_lib/fpdf/reporte_de.php");
...
//crear select option
function select_option($tabla,$value,$mostrar,$filtro=null)
{
	//realizamos conexion
	if(isset($_SESSION['INGRESO']['IP_VPN_RUTA'])) 
	{
