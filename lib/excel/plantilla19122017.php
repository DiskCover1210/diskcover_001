...
function excel_file($stmt,$ti=null,$camne=null,$b=null) 
{
	...
	if(isset($_SESSION['INGRESO']['Logo_Tipo'])) 
	{
		...
		//si es jpg
		$src = __DIR__ . '/../../diskcover_img/logotipos/'.$logo.'.jpg'; 
		if (@getimagesize($src)) 
		{ 
			$logo=$logo.'.jpg';
		}
		...
		{
			//si es gif
			$src = __DIR__ . '/../../diskcover_img/logotipos/'.$logo.'.gif'; 
			if (@getimagesize($src)) 
			{ 
				$logo=$logo.'.gif';
			}
			...
			{
				//si es png
				$src = __DIR__ . '/../../diskcover_img/logotipos/'.$logo.'.png'; 
				if (@getimagesize($src)) 
				{ 
					$logo=$logo.'.png';
				}
	...
	$drawing->setPath(__DIR__ . '/../../diskcover_img/logotipos/'.$logo);
